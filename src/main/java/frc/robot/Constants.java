...
public final class Constants {
  ...
  public static final class SwerveConstants{
   ...
   public static final double driveKFF = 0.0; //to tune
    ...
    public static final DCMotor DRIVE_DC_MOTOR = DCMotor.getNeo550(1);
...
public static final class PPconstants{
  ...
  public static final RobotConfig PPConfig = new RobotConfig(
      robotMassKG,
      MOI,
      new ModuleConfig(SwerveConstants.wheelDiameter/2, SwerveConstants.maxSpeed, 1, SwerveConstants.DRIVE_DC_MOTOR,
       SwerveConstants.driveContinuousCurrentLimit, 1),
      SwerveConstants.swerveKinematics.getModules());
